...
import { AffiliationForm, AffiliationFormValues } from './AffiliationForm'
...
const normalize = (affiliation: Affiliation): AffiliationFormValues => ({
  _id: affiliation._id,
...
export const AffiliationButton: React.FC<AffiliationButtonProps> = ({
  ...
  const handleSave = (values: AffiliationFormValues) => {
    if (isEqual(values, normalize(affiliation))) {
      return
    }
    const copy = {
      ...affiliation,
