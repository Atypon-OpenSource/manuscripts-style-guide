...
export type AuthorDetailsFormValues = Pick<
  Contributor,
  | '_id'
  | 'email'
  | 'isCorresponding'
...
interface AuthorDetailsFormProps {
  values: AuthorDetailsFormValues
  onChange: (values: AuthorDetailsFormValues) => void
  onSave: (values: AuthorDetailsFormValues) => void
}
...
export const AuthorDetailsForm: React.FC<AuthorDetailsFormProps> = ({
  ...
  return (
    <Formik<AuthorDetailsFormValues>
